...
public class EarthquakeCityMap extends PApplet {
	...
	private void addKey() {	
		...
		fill(color(0, 0, 255));
		ellipse(50, 320, 20, 20);
		fill(color(255, 0, 0));
		ellipse(50, 360, 20, 20);
		fill(color(255, 255, 255));
		...
		text("Size - Magnitude", 75, 250);
		text("Shallow", 75, 280);
		text("Intermediate", 75, 320);
		text("Deep", 75, 360);
		text("Past Day", 75, 400);
	}
	...
	private void printQuakes() 
	{
		...
		for(Marker cm: countryMarkers) {
			...
			for(Marker m : quakeMarkers) {
				...
				if(((EarthquakeMarker) m).isOnLand() && cm.getProperty("name").equals(m.getProperty("country"))) {
					counter += 1;
				}
			...
			System.out.println("There are " + ocean + " earthquakes in the sea");
			System.out.println("There are " + counter + " earthquakes in " + (String)cm.getProperty("name"));
		}
