...
public class EarthquakeCityMap extends PApplet {
	...
	private void cityClicked() {
		...
		for(Marker m1 : quakeMarkers) {
			double threat = ((EarthquakeMarker) m1).threatCircle();
			if(m1.getDistanceTo(lastClicked.getLocation()) > threat) {
				m1.setHidden(true);
			}
		}
	}
	...
	public void mouseClicked()
	{
		...
		if(!cityMarkers.contains(lastClicked) && !quakeMarkers.contains(lastClicked)) {
			unhideMarkers();
		}
